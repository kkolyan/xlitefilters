...
namespace Kk.XLiteFilters
{
    ...
    public sealed class TypedFilter<T1, T2, T3, T4, T5> : TypedFilter
            where T1 : struct
            where T2 : struct
            where T3 : struct
            where T4 : struct
            where T5 : struct
    {
        ...
        public TypedFilter(EcsWorld world)
        {
            filter = world.Filter<T1>().Inc<T2>().Inc<T3>().Inc<T4>().Inc<T5>().End();
            pool1 = world.GetPool<T1>();
            pool2 = world.GetPool<T2>();
            pool3 = world.GetPool<T3>();
            pool4 = world.GetPool<T4>();
    ...
    public sealed class TypedFilter<T1, T2, T3, T4, T5, T6> : TypedFilter
            where T1 : struct
            where T2 : struct
            where T3 : struct
            where T4 : struct
            ...
            where T6 : struct
    {
        ...
        public TypedFilter(EcsWorld world)
        {
            filter = world.Filter<T1>().Inc<T2>().Inc<T3>().Inc<T4>().Inc<T5>().Inc<T6>().End();
            pool1 = world.GetPool<T1>();
            pool2 = world.GetPool<T2>();
            pool3 = world.GetPool<T3>();
            pool4 = world.GetPool<T4>();
    ...
    public sealed class TypedFilter<T1, T2, T3, T4, T5, T6, T7> : TypedFilter
            where T1 : struct
            where T2 : struct
            where T3 : struct
            where T4 : struct
            ...
            where T7 : struct
    {
        ...
        public TypedFilter(EcsWorld world)
        {
            filter = world.Filter<T1>().Inc<T2>().Inc<T3>().Inc<T4>().Inc<T5>().Inc<T6>().Inc<T7>().End();
            pool1 = world.GetPool<T1>();
            pool2 = world.GetPool<T2>();
            pool3 = world.GetPool<T3>();
            pool4 = world.GetPool<T4>();
    ...
    public sealed class TypedFilter<T1, T2, T3, T4, T5, T6, T7, T8> : TypedFilter
            where T1 : struct
            where T2 : struct
            where T3 : struct
            where T4 : struct
            ...
            where T8 : struct
    {
        ...
        public TypedFilter(EcsWorld world)
        {
            filter = world.Filter<T1>().Inc<T2>().Inc<T3>().Inc<T4>().Inc<T5>().Inc<T6>().Inc<T7>().Inc<T8>().End();
            pool1 = world.GetPool<T1>();
            pool2 = world.GetPool<T2>();
            pool3 = world.GetPool<T3>();
            pool4 = world.GetPool<T4>();
